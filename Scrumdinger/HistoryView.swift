    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading) {
                ...
                // Use optional binding to safely unwrap the value of transcript. If a transcript has a value, display “Transcript,” followed by the transcript text.
...
// Add a History extension with a list formatter to display attendees in a human-readable string. Then add a text view, and pass in the meeting attendees.
